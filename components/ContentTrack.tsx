...
export const ContentTrack: React.FC<ContentTrackProps> = ({ title, items, featured = false }) => {
  return (
    <div className="mb-12">
      <h2 className="text-2xl font-bold text-white mb-4 px-4 lg:px-0">{title}</h2>
      <div className="flex gap-4 overflow-x-auto pb-4 px-4 lg:px-0 scrollbar-hide">
        {items.map((item) => (
          ...
          >
            {/* Thumbnail Container */}
            <div className="relative aspect-video rounded-lg overflow-hidden bg-gradient-to-br from-slate-800 to-slate-900 border border-[#1a1a1a]">
